...
class BackgroundJobDetectionResult:
    ...
    @property
    def by_job_type(self) -> Dict[str, int]:
        """Count jobs by type."""
        return self._count_by_type()

    @property
    def by_trigger_type(self) -> Dict[str, int]:
        """Count jobs by trigger type."""
        return self._count_by_trigger()
...
class ConnectionPoolConfig:
    ...
    @property
    def name(self) -> str:
        """Alias for connection_string_name for API compatibility."""
        return self.connection_string_name
...
class DocumentationExtractionResult:
    ...
    def by_type(self) -> Dict[str, int]:
        """Alias for rules_by_type for API compatibility."""
        return self.rules_by_type
