"""
Task Generation API Routes (Week 11)
...
router = APIRouter(prefix="/api/week11", tags=["Task Generation"])
...
async def get_hierarchy_summary(
    ...
    **Use Cases**:
    ...
    """
    from app.services.week11.validation_service import get_validation_service
