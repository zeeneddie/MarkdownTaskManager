...
app.include_router(software_intake.router)  # Week 158: Software Intake - Automated Code Analysis (Fase 1 - 0 Questions)
...
app.include_router(streaming.router)  # Week 158: LLM Streaming & Resilience (Fase 24.5 - SSE Endpoints, Circuit Breaker)
app.include_router(workflow_checkpoints.router, prefix="/api")  # Week 158: Restartable Workflows (Fase 24.6 - Checkpoints)
app.include_router(migration_patterns.router)  # Week 159: Migration Patterns (Fase 24 GAP D4 - Central Pattern Catalog)
app.include_router(aspnetcore_analyzer.router)  # Week 159: ASP.NET Core Analyzer (Fase 24 GAP B5 - Modern .NET Analysis)
app.include_router(php_modern_analyzer.router)  # Week 159: PHP Modern Analyzer (Fase 24 GAP B6 - PHP 8.x Analysis)
app.include_router(unified_onboarding.router)  # Week 159: Unified Onboarding (4e Brown Paper Workflow - Reconciliation)
app.include_router(knowledge_base.router)  # KB1/KB5: Knowledge Base (Famous Bugs + Post-Mortems)
