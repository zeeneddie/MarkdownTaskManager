...
def improving_metrics():
    ...
    return AgentPerformanceMetrics(
        ...
        successful_experiments=85,
        failed_experiments=15,
        success_rate=85.0,
        avg_iterations=2.1,
...
def declining_metrics():
    ...
    return AgentPerformanceMetrics(
        agent_id="Marcus",
        total_experiments=100,
        successful_experiments=65,
        failed_experiments=35,
        success_rate=65.0,
        avg_iterations=2.8,
        improvement_rate=-25.0,
        daily_success_rates=daily_rates,
...
def volatile_metrics():
    ...
    return AgentPerformanceMetrics(
        agent_id="Quinn",
        total_experiments=100,
        successful_experiments=75,
        failed_experiments=25,
        success_rate=75.0,
        avg_iterations=2.4,
...
def stable_metrics():
    ...
    return AgentPerformanceMetrics(
        agent_id="Betty",
        total_experiments=100,
        successful_experiments=80,
        failed_experiments=20,
        success_rate=80.0,
        avg_iterations=2.2,
        improvement_rate=0.0,
        daily_success_rates=daily_rates,
...
class TestEdgeCases:
    ...
    async def test_insufficient_data_points(self, trend_service, time_range_30d):
        ...
        sparse_metrics = AgentPerformanceMetrics(
            ...
            avg_iterations=2.0,
            improvement_rate=0.0,
            daily_success_rates=[(datetime.utcnow(), 80.0) for _ in range(5)],
            recent_experiments=[]
        )
