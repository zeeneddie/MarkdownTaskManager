...
"""
    ...
    def test_parse_jest_coverage(self, service, temp_jest_coverage):
        ...
        assert result.line_coverage_percentage > 0
    ...
    def test_cobertura_percentages(self, service, temp_cobertura_coverage):
        ...
        assert result.line_coverage_percentage == 80.0
    ...
    def test_include_file_details(self, service, temp_jest_coverage):
        ...
        assert len(result.file_coverages) > 0
        for fc in result.file_coverages:
    ...
    def test_check_thresholds_pass(self, service, temp_cobertura_coverage):
        ...
        assert "failed_checks" in threshold_result
    ...
    def test_check_thresholds_fail(self, service_strict, temp_jest_coverage):
        ...
        assert threshold_result["passed"] is False or len(threshold_result["failed_checks"]) > 0
    ...
    def test_auto_detect_lcov(self, service, temp_lcov_coverage):
        ...
        assert result.coverage_source == CoverageSource.LCOV
    ...
    def test_compare_coverage(self, service, temp_jest_coverage):
        ...
        assert "line_coverage_delta" in comparison
        assert comparison["line_coverage_delta"] == 5.0
        assert comparison["branch_coverage_delta"] == -2.0
